    ...
    <nav className="navigation">
      ...
      <Flipper flipKey={dropdownStatus} spring="noWobble">
        <ul>
          ...
          <Dropdown title="Components" icon={<i className="fas fa-cube"></i>} link="/components" subMenu={{"Buttons": "/buttons"}} dropdownSatusChange={dropdownSatusChange} {...props} />
          <Dropdown title="Settings" icon={<i className="fas fa-cog"></i>} link="/settings" subMenu={{"User": "/user", "Payment": "/payment"}} dropdownSatusChange={dropdownSatusChange} {...props} />
          <Flipped flipId="15156"><li><NavLink to="/whatisnew"><i className="fas fa-file-alt"></i> <span>What's New ?</span></NavLink></li></Flipped>
        </ul>
      </Flipper>
    </nav>
  );
